...
// g++cmd:g++ -o led_02 led_02.c -Wall -I /home/metoro/rpi-rgb-led-matrix/include -L /home/metoro/rpi-rgb-led-matrix/lib -lrgbmatrix -lwiringPi -I /home/metoro/stb
...
int main(/*int argc, char **argv*/ void)
{
    ...
    char argv_1[] = "--led-no-drop-privs"; // root権限を維持
    char argv_2[] = "--led-slowdown-gpio=2";
    argv[1] = argv_1;
    argv[2] = argv_2;

    matrix_options = led_matrix_create_from_options(&options, &argc, &argv); // 関数に設定を渡して構造体に格納してもらう
