// g++cmd:g++ -o led_04 led_04.c -Wall -I /home/metoro/rpi-rgb-led-matrix/include -L /home/metoro/rpi-rgb-led-matrix/lib -lrgbmatrix -I /home/metoro/stb -g
...
void print_panel(int, int, unsigned char *);                  // データをパネルに反映
...
int main(int argc, char **argv)
{
    ...
    char **argv_add = NULL;
    char argv_add_tmp[][256] = {"--led-slowdown-gpio=2", "--led-no-drop-privs", "--led-cols=64", "--led-rows=32", "--led-chain=3", "--led-pwm-bits=4"}; // 補完するオプション
    ...
    while (1)
    {
        for (int i = 0; i < file_num; i++)
        {
            ...
            print_panel(image_x, image_y, pixel); // データをパネルに反映
...
void print_panel(int led_width, int led_height, unsigned char *pixel) // データを(パネルに表示パネル制御系の構造体をグローバルで宣言すること
{
